...
#define PIN_SLIDER_HALL A2
#define PIN_INPUT_VOLTAGE A5
#define PIN_ENABLE 8 //EN
#define PIN_MS1 11
#define PIN_MS2 10
#define PIN_STEP_SLIDER 4
#define PIN_DIRECTION_SLIDER 7 //Z
#define PIN_STEP_TILT 3
#define PIN_DIRECTION_TILT 6 //Y
#define PIN_STEP_PAN 2
#define PIN_DIRECTION_PAN 5 //X
